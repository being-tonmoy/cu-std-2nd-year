...
const SubmissionManagement = () => {
  ...
  const downloadCSV = () => {
    const dataToExport = selectedIds.size > 0 
      ? filteredSubmissions.filter(sub => selectedIds.has(sub.id))
      : filteredSubmissions;
    ...
    if (dataToExport.length === 0) {
      Swal.fire({
        icon: 'warning',
        title: 'No Data',
        text: selectedIds.size > 0 
          ? 'No submissions selected for download' 
    ...
    Swal.fire({
      icon: 'success',
      title: 'Downloaded',
      text: `${dataToExport.length} submissions exported to CSV`,
      timer: 2000,
      confirmButtonColor: '#001f3f'
    });
  };
    ...
    <>
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        {loading ? (
          ...
          <>
            {selectedIds.size > 0 && (
              <Box sx={{ mb: 2, p: 2, bgcolor: '#e3f2fd', borderRadius: '4px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <TableRow>
                    <TableCell sx={{ color: 'white', fontWeight: 'bold', backgroundColor: '#001f3f', width: '50px' }}>
                      <Checkbox
                        ...
                        indeterminate={selectedIds.size > 0 && selectedIds.size < filteredSubmissions.length}
                    ...
                    filteredSubmissions
                      ...
                      .map((submission) => (
                        <TableRow 
                          ...
                          sx={{
                            backgroundColor: selectedIds.has(submission.id) ? '#f5f5f5' : 'transparent'
                          }}
                        >
                          <TableCell>
                            <Checkbox
